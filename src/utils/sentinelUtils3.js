...
const BASE_URL = "https://sh.dataspace.copernicus.eu/ogc/wms/2777646e-6efc-437a-960f-25534461007d";
const SEARCH_API_BASE = "https://catalogue.dataspace.copernicus.eu/resto/api/collections/Sentinel1/search.json";
...
export const createSentinel3Layer = (layerId, bands, startDate, endDate, opacity = 0.8, productId = null) => {
...
export const getProductDetails = async (productId) => {
  try {
    const detailUrl = `https://catalogue.dataspace.copernicus.eu/resto/api/collections/Sentinel1/${productId}.json`;
